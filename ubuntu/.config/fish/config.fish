...
### MISE COMPLETIONS
# mise embeds its completion engine and the generated function calls back into the
# active mise binary, so sourcing it at startup follows self-updates automatically.
if status is-interactive
