...
#
# Deliberately absent: ~/.codex-kiro. That Codex fork is deprecated and was
# removed from this machine on 2026-08-08 (binaries, CODEX_HOME, and clone);
# do not re-add it as a target.
#
